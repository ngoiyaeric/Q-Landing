...
<>
    ...
    >
        ...
        <Skill name="🌊" x="-20vw" y="2vw" />
          ...
          <Skill name="🏞️" x="-5vw" y="-10vw" />
          <Skill name="🌴" x="20vw" y="6vw" />
          <Skill name="🌳" x="0vw" y="12vw" />
          <Skill name="🦜" x="-20vw" y="-15vw" />
          <Skill name="🧭" x="15vw" y="-12vw" />
          <Skill name="🌍" x="-35vw" y="-5vw" />
          <Skill name="🍃" x="32vw" y="-5vw" />
          <Skill name="🎮" x="0vw" y="-20vw" />
          <Skill name="🤖" x="-25vw" y="18vw" />
          <Skill name="🎵" x="28vw" y="18vw" />
    </div></>
  );
};
